...
HD_PWD='C:/Users/axel/Desktop/Projet/Serpenteirb/Serpenteirb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_du_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_du_top.tcl -notrace
