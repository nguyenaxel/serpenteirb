...
HD_PWD='C:/Users/axel/Desktop/Projet/Serpenteirb/Serpenteirb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_du_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_du_top.tcl
